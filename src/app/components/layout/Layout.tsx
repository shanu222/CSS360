...
export function Layout() {
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <aside
        className={`
          fixed lg:relative z-50 flex flex-col bg-[#0f3d2b] text-white h-full
      ...
      >
        ...
        <div className="hidden lg:flex p-3 border-t border-white/10">
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-lg text-white/60 hover:text-white hover:bg-white/10 transition-all w-full"
          >
        ...
        {!collapsed && (
          <div className="p-3 border-t border-white/10">
            <div className="flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-white/10 cursor-pointer transition-all">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Top Header */}
        <header className="flex items-center gap-4 bg-white border-b border-gray-200 px-4 lg:px-6 py-3 flex-shrink-0">
          <button
          ...
          <div className="flex items-center gap-2">
            {/* Search */}
            <div className="hidden md:flex items-center gap-2 bg-gray-100 rounded-lg px-3 py-1.5 w-52">
            ...
            <div className="hidden sm:flex items-center gap-1.5 bg-green-50 border border-green-200 rounded-lg px-3 py-1.5">
              ...
              <span className="text-green-700 text-xs font-medium">Day 142</span>
            </div>
          </div>
        </header>
